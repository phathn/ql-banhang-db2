...
import Persistences.Customercategories;
 ...
 * @author db2admin
 */
public class TableCustomerCategories {
    ...
    public static void loadDataIntoTableBook(JTable table, ArrayList<Customercategories> lstItem) {
        table.setRowHeight(18);
        arrCol = new Vector<String>();
        columnNames = new String[]{"", "ID", "Name", "Discount (%)"};
     ...
     */
    public static void addElementIntoTableAddressBook(ArrayList<Customercategories> lstItem) {
        ...
        for (int i = 0; i < lstItem.size(); i++) {
            ...
            a.add(lstItem.get(i).getName());
            a.add(lstItem.get(i).getDiscount());
