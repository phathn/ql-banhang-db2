...
import Persistences.Productcategories;
 ...
 * @author db2admin
 */
public class TableProductCategories {
    ...
    public static void loadDataIntoTableBook(JTable table, ArrayList<Productcategories> lstItem) {
     ...
     */
    public static void addElementIntoTableAddressBook(ArrayList<Productcategories> lstItem) {
        ...
        for (int i = 0; i < lstItem.size(); i++) {
            ...
            a.add(lstItem.get(i).getDescription());
