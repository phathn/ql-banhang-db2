...
public class TableProducers {
    ...
    public static void loadDataIntoTableBook(JTable table, ArrayList<Producers> lstItem) {
        table.setRowHeight(18);
        arrCol = new Vector<String>();
        columnNames = new String[]{"", "ID", "Name", "Nation"};
     ...
     */
    public static void addElementIntoTableAddressBook(ArrayList<Producers> lstItem) {
