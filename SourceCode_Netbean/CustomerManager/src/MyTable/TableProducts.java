...
public class TableProducts {
    ...
    public static void loadDataIntoTableBook(JTable table, ArrayList<Products> lstItem) {
        table.setRowHeight(18);
        arrCol = new Vector<String>();
        columnNames = new String[]{"", "ID", "Category", "Name"};
     ...
     */
    public static void addElementIntoTableAddressBook(ArrayList<Products> lstItem) {
        ...
        for (int i = 0; i < lstItem.size(); i++) {
            ...
            a.add(lstItem.get(i).getIdproductcategory().getName());
