...
public class JDayChooser extends JPanel implements ActionListener, KeyListener,
    ...
    private JTable _tblCalendar_GhiChu;

    /**
     * Default JDayChooser constructor.
     */
    public JDayChooser(JTable tblCalendar_GhiChu) {
        this(false, tblCalendar_GhiChu);
    }
     ...
     */
    public JDayChooser(boolean weekOfYearVisible, JTable tblCalendar_GhiChu) {
        _tblCalendar_GhiChu = tblCalendar_GhiChu;
        ...
        sundayForeground = new Color(220, 0, 0);
        ...
        for (int y = 0; y < 7; y++) {
            for (int x = 0; x < 7; x++) {
                ...
                if (y == 0) {
                    ...
                    days[index].setFont(new java.awt.Font("Microsoft Sans Serif", 0, 11));
                } else {
                    ...
                    days[index].setBorderPainted(decorationBordersVisible);
                    days[index].setFont(new java.awt.Font("Microsoft Sans Serif", 0, 10));
                }
