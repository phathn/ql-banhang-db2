...
/*
 * DlgCustomercategories.java
 *
 * Created on Jul 12, 2011, 12:44:36 AM
 */
package OtherForms;

import Helpers.IntTextField;
import Persistences.*;
import Repositories.*;
 ...
 * @author letuan
 */
public class DlgCustomerCategories extends javax.swing.JDialog {

    public String DataTranfered = "";

    /** Creates new form DlgCustomercategories */
    public DlgCustomerCategories(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        loadData();
    }
    ...
    /** Creates new form DlgCustomercategories */
    public DlgCustomerCategories(java.awt.Frame parent, boolean modal, boolean EnableChoose) {
        super(parent, modal);
        initComponents();
        loadData();
    ...
    public void loadData() {
        ArrayList<Customercategories> lstItem = new ArrayList<Customercategories>();
        lstItem = CustomerCategoriesRepository.selectAll();
        MyTable.TableCustomerCategories.loadDataIntoTableBook(tblData, lstItem);
    }

    public void loadInfoByID(int id) {
        Customercategories item = CustomerCategoriesRepository.selectByID(id);
    ...
    private void initComponents() {
        ...
        jLabel5.setText("   List of Customer Categories");
        ...
        jLabel1.setText("Customer Category Infomation");
    ...
    private void btnChooseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnChooseActionPerformed
        ...
        DataTranfered = txtID.getText() + "#" + txtName.getText();
        this.dispose();
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if (JOptionPane.showConfirmDialog(null, "Are you sure you want to delete this item", "Announcement", JOptionPane.OK_CANCEL_OPTION) == 0) {
            ...
            if (CustomerCategoriesRepository.delete(Integer.parseInt(id))) {
                loadData();
                resetInputData();
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        if (txtID.getText().equals("")) {
            // Insert new item
            Customercategories item = new Customercategories();
            item.setName(txtName.getText());
            item.setDiscount(Float.valueOf(txtDiscount.getText()));
            if (CustomerCategoriesRepository.insert(item)) {
                updated = true;
            }
        } else {
            // Update item
            Customercategories item = CustomerCategoriesRepository.selectByID(Integer.parseInt(txtID.getText()));
            item.setName(txtName.getText());
            item.setDiscount(Float.valueOf(txtDiscount.getText()));
            if (CustomerCategoriesRepository.save(item)) {
                updated = true;
            }
        }
        if (updated) {
    ...
    public void resetInputData() {
        ...
        txtName.setText("");
        txtDiscount.setText("");
        txtDiscount.getDocument().addDocumentListener(null);
    }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            ...
            public void run() {
                DlgCustomerCategories dialog = new DlgCustomerCategories(new javax.swing.JFrame(), true);
