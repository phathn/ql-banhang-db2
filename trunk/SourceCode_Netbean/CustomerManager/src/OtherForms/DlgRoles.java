 ...
 * @author letuan
 */
public class DlgRoles extends javax.swing.JDialog {

    public String DataTransfered;
    
    /** Creates new form DlgProducers */
    public DlgRoles(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        loadData();
    }
    ...
    /** Creates new form DlgProducers */
    public DlgRoles(java.awt.Frame parent, boolean modal, boolean EnableChoose) {
        super(parent, modal);
        initComponents();
        loadData();
    ...
    public void loadData() {
        ArrayList<Roles> lstItem = new ArrayList<Roles>();
        lstItem = RolesRepository.selectAll();
        MyTable.TableRoles.loadDataIntoTableBook(tblData, lstItem);
    }

    public void loadInfoByID(int id) {
        Roles item = RolesRepository.selectByID(id);
        txtID.setText(String.valueOf(item.getId()));
        txtName.setText(item.getRolename());
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Role Infomation");
    ...
    private void btnDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDeleteActionPerformed
        ...
        if (JOptionPane.showConfirmDialog(null, "Are you sure you want to delete this item", "Announcement", JOptionPane.OK_CANCEL_OPTION) == 0) {
            String id = ((JLabel) tblData.getValueAt(this.tblData.getSelectedRow(), 0)).getName().trim();
            if (RolesRepository.delete(Integer.parseInt(id))) {
                loadData();
                resetInputData();
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        if (txtID.getText().equals("")) {
            ...
            item.setRolename(txtName.getText());
            if (RolesRepository.insert(item)) {
                updated = true;
            }
        } else {
            // Update item
            Roles item = RolesRepository.selectByID(Integer.parseInt(txtID.getText()));
            item.setRolename(txtName.getText());
            if (RolesRepository.save(item)) {
                updated = true;
            }
        }
        if (updated) {
    ...
    */
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DlgRoles dialog = new DlgRoles(new javax.swing.JFrame(), true);
