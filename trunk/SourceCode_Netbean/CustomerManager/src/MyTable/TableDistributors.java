 ...
 * @author db2admin
 */
public class TableDistributors {
    ...
    public static void loadDataIntoTableBook(JTable table, ArrayList<Distributors> lstItem) {
     ...
     */
    public static void addElementIntoTableAddressBook(ArrayList<Distributors> lstItem) {
