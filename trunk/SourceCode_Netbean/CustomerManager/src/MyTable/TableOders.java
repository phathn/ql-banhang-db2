...
public class TableOders {
    ...
    public static void loadDataIntoTableBook(JTable table, ArrayList<Orders> lstItem) {
        table.setRowHeight(18);
        arrCol = new Vector<String>();
        columnNames = new String[]{"", "OrderDate", "Customer"};
     ...
     */
    public static void addElementIntoTableAddressBook(ArrayList<Orders> lstItem) {
