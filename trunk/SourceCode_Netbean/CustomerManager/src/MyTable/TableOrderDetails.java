...
public class TableOrderDetails {
    ...
    public static void loadDataIntoTableBook(JTable table, ArrayList<Orderdetails> lstItem) {
        table.setRowHeight(18);
        arrCol = new Vector<String>();
        columnNames = new String[]{"", "Number", "Product", "Quantity", "Unit.Price"};
        ...
        //sortAllRowByyFullName(model, 1, true);
        ///////////////
     ...
     */
    public static void addElementIntoTableAddressBook(ArrayList<Orderdetails> lstItem) {
        ...
        for (int i = 0; i < lstItem.size(); i++) {
            ...
            //lb.setName(String.valueOf(lstItem.get(i).()));
            ...
            a.add(lstItem.get(i).getIdproduct().getName());
            a.add(String.valueOf(lstItem.get(i).getQuantity()));
            a.add(String.valueOf(lstItem.get(i).getPrice()));
