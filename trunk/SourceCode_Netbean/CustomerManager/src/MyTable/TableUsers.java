...
public class TableUsers {
    ...
    public static void loadDataIntoTableBook(JTable table, ArrayList<Users> lstItem) {
        table.setRowHeight(18);
        arrCol = new Vector<String>();
        columnNames = new String[]{"", "ID", "Role", "Username"};
     ...
     */
    public static void addElementIntoTableAddressBook(ArrayList<Users> lstItem) {
        ...
        for (int i = 0; i < lstItem.size(); i++) {
            ...
            a.add(lstItem.get(i).getIdrole().getRolename());
            a.add(lstItem.get(i).getUsername());
