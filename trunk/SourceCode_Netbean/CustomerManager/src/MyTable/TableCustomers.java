...
public class TableCustomers {
    ...
    public static void loadDataIntoTableBook(JTable table, ArrayList<Customers> lstItem) {
        table.setRowHeight(18);
        arrCol = new Vector<String>();
        columnNames = new String[]{"", "ID", "Customer Category", "Name"};
     ...
     */
    public static void addElementIntoTableAddressBook(ArrayList<Customers> lstItem) {
        ...
        for (int i = 0; i < lstItem.size(); i++) {
            ...
            a.add(lstItem.get(i).getIdcategory().getName());
